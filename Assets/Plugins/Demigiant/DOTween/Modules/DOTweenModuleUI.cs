...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
    {
        ...
        public static TweenerCore<float, float, FloatOptions> DOFade(this CanvasGroup target,float starValue, float endValue, float duration)
        {
            TweenerCore<float, float, FloatOptions> t = DOTween.To(() => target.alpha, x => target.alpha = x, endValue, duration).ChangeStartValue(starValue);
            t.SetTarget(target);
            return t;
        }
